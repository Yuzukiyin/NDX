...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        >
          <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
            ...
            <motion.button
              ...
              type="submit"
              disabled={loading}
              className="w-full bg-white text-gray-900 py-3 sm:py-4 rounded-xl sm:rounded-2xl font-bold text-sm sm:text-base tracking-wide hover:bg-gray-100 transition-all duration-300 shadow-xl hover:shadow-2xl disabled:opacity-50 disabled:cursor-not-allowed mt-6 sm:mt-8"
            >
              {loading ? (
